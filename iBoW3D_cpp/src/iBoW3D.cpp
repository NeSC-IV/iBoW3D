...
namespace iBoW3D
{
    ...
    void iBoW3D::get_dictionary_and_histogram()
    {
        ...
        for(int i = 0; i < DB_len; i++)
        {
            ...
            // cout << "size DB i: " << endl;
            // cout << key_feat_DB[i].rows << endl;
            // cout << key_feat_DB[i].cols << endl;
            // key_feat_DB[i].copyTo(keyFeatures(Rect(0, i*keypoint_num, feature_dim, keypoint_num)));
        }
