...
namespace iBoW3D
{
    class DataBase
    {
        public:
            ...
            void add_pcloud(pcl::PointCloud<pcl::PointXYZ>::Ptr pcloud);
            ...
            pcl::PointCloud<pcl::PointXYZ>::Ptr get_cloud_by_idx(int idx){ return pcloud_DB[idx]; }
        ...
        private:
            ...
            vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> pcloud_DB;
